...
extern "C" {
	...
	gaspi_return_t pgaspi_wait (gaspi_queue_id_t queue, gaspi_timeout_t timeout);
	gaspi_return_t pgaspi_proc_rank (gaspi_rank_t *rank);
	gaspi_return_t pgaspi_proc_num ( gaspi_rank_t *proc_num );
	gaspi_return_t pgaspi_barrier ( gaspi_group_t group, gaspi_timeout_t timeout);
	gaspi_return_t pgaspi_write ( gaspi_segment_id_t segment_id_local
	...
	gaspi_return_t pgaspi_read ( gaspi_segment_id_t segment_id_local
           , gaspi_offset_t offset_local
           , gaspi_rank_t rank
           , gaspi_segment_id_t segment_id_remote
           , gaspi_offset_t offset_remote
	...
	gaspi_return_t pgaspi_write_notify ( gaspi_segment_id_t segment_id_local
           , gaspi_offset_t offset_local
           , gaspi_rank_t rank
           , gaspi_segment_id_t segment_id_remote
           , gaspi_offset_t offset_remote
	...
	gaspi_return_t pgaspi_notify ( gaspi_rank_t rank
           , gaspi_notification_id_t flag_id
           , gaspi_notification_t flag_value
           , gaspi_queue_id_t queue
           , gaspi_timeout_t timeout
           );
	gaspi_return_t pgaspi_notify_waitsome ( gaspi_notification_id_t flag_id_beg
           , gaspi_notification_id_t flag_num
           , gaspi_timeout_t timeout
           );
	gaspi_return_t pgaspi_notify_reset ( gaspi_notification_id_t flag_id
           , gaspi_notification_t* flag_val
           );
	gaspi_return_t pgaspi_notification_num ( gaspi_notification_id_t* flag_max );
	gaspi_return_t pgaspi_segment_ptr ( gaspi_segment_id_t segment_id
	...
	gaspi_return_t pgaspi_passive_send ( gaspi_segment_id_t segment_id_local
           , gaspi_offset_t offset_local
           , gaspi_rank_t rank
           , gaspi_size_t size
           , gaspi_tag_t tag
	...
	gaspi_return_t pgaspi_passive_wait (gaspi_timeout_t timeout);                   
  ...
  gaspi_return_t pgaspi_queue_size_max ( gaspi_queue_id_t queue , gaspi_number_t* queue_size);
	...
	gaspi_return_t pgaspi_statistic_counter_info(gaspi_statistic_counter_t counter
	...
	gaspi_return_t pgaspi_statistic_counter_get ( gaspi_statistic_counter_t counter
