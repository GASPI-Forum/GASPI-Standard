...
!
! the fortran user defined callback function requires an explicit
! type. in this case integer(c_int)
!
  ...
  integer i
!
! replace with your user defined operation       
!
! do i = 1, num
...
&         result( res ) bind(C, name="gaspi_passive_transfer_size_max")
  integer(gaspi_size_t) :: transfer_size_max
  integer(gaspi_return_t) :: res
...
&         result( res ) bind(C, name="gaspi_build_infrastructure")
