...
language (like Chapel from Cray), nor an extension to a
...
some of the parameters are externally set by the program and assigned with \gaspifunction{config\_set},
...
\parameterlistbegin
\parameterlistitem{in}{config}{the configuration to be used}
...
\begin{verbatim}
gaspi_return_t
gaspi_proc_init ( gaspi_configuration_t const *config
...
\begin{verbatim}
gaspi_return_t
gaspi_notify_waitsome ( gaspi_notification_id_t 
                              notification_begin
                      , gaspi_number_t notification_num
                      , gaspi_timeout_t timeout )
\end{verbatim}
