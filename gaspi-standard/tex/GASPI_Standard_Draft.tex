...
gaspi_config_get ( config ) BIND(C)
  TYPE(gaspi_config_t), INTENT(OUT) :: config
...
gaspi_config_set ( config ) BIND(C)
  TYPE(gaspi_config_t), INTENT(IN) :: config
  TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
\begin{FDefSign}
\begin{verbatim}
gaspi_proc_init ( timeout ) BIND(C)
...
\begin{FDefSign}
\begin{verbatim}
gaspi_group_create ( group ) BIND(C)
  TYPE(gaspi_group_t), INTENT(OUT) :: group
  TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_group_add ( group
                , rank ) BIND(C)
  TYPE(gaspi_group_t), INTENT(OUT) :: group
  TYPE(gaspi_rank_t), INTENT(IN) :: group
  TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_group_ranks ( group
  ...
  TYPE(gaspi_rank_t), INTENT(OUT) :: group_ranks(*)
  TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_notify_waitsome ( segment_id
  ...
  TYPE(gaspi_notification_id_t), INTENT(OUT):: first_id
  TYPE(gaspi_timeout_t), INTENT(IN) :: timeout
  TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_queue_size ( queue
  ...
  TYPE(gaspi_queue_id_t), INTENT(IN) :: queue
  TYPE(gaspi_number_t), INTENT(OUT) :: queue_size
  TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_allreduce ( buffer_send
    ...
    TYPE(gaspi_pointer_t), INTENT(IN) :: buffer_send
    TYPE(gaspi_pointer_t), INTENT(IN) :: buffer_receive
    TYPE(gaspi_number_t), INTENT(IN) :: num
    TYPE(gaspi_operation_t), INTENT(IN) :: operation
    TYPE(gaspi_datatype_t), INTENT(IN) :: datatype
    TYPE(gaspi_group_t), INTENT(IN) :: group
    TYPE(gaspi_timeout_t), INTENT(IN) :: timeout
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
...
gaspi_allreduce_user ( buffer_send
    ...
    TYPE(gaspi_pointer_t), INTENT(IN) :: buffer_receive
    TYPE(gaspi_number_t), INTENT(IN) :: num
    TYPE(gaspi_size_t), INTENT(IN) :: size_element
    TYPE(gaspi_reduce_operation_t),INTENT(IN):: reduce_operation
    TYPE(gaspi_reduce_state_t), INTENT(IN) :: reduce_state
    TYPE(gaspi_group_t), INTENT(IN) :: group
    TYPE(gaspi_timeout_t), INTENT(IN) :: timeout
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
...
gaspi_reduce_operation ( operand_one
    ...
    TYPE(gaspi_pointer_t), INTENT(IN) :: operand_one
    TYPE(gaspi_pointer_t), INTENT(IN) :: operand_two
    TYPE(gaspi_pointer_t), INTENT(IN) :: result
    TYPE(gaspi_reduce_state_t), INTENT(IN) :: state
    TYPE(gaspi_timeout_t), INTENT(IN) :: timeout
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_group_max ( group_max
    ...
    TYPE(gaspi_number_t), INTENT(OUT) :: group_max
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_segment_max ( segment_max
    ...
    TYPE(gaspi_number_t), INTENT(OUT) :: segment_max
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
\executionphasework
...
gaspi_queue_num ( queue_num
    ...
    TYPE(gaspi_number_t), INTENT(OUT) :: queue_num
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_queue_size_max ( queue_size_max 
    ...
    TYPE(gaspi_number_t), INTENT(OUT) :: queue_size_max
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_transfer_size_max ( transfer_size_max)
    ...
    TYPE(gaspi_number_t), INTENT(OUT) :: transfer_size_max
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_notification_num ( notification_num
    ...
    TYPE(gaspi_number_t), INTENT(OUT) :: notification_num
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_passive_transfer_size_max ( transfer_size_max
    ...
    TYPE(gaspi_size_t), INTENT(OUT) :: transfer_size_max
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_atomic_max ( max_value
    ...
    TYPE(gaspi_atomic_value_t), INTENT(OUT) :: max_value
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
\executionphasework
...
gaspi_allreduce_buf_size ( buf_size
    ...
    TYPE(gaspi_size_t), INTENT(OUT) :: buf_size
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
\executionphasework
...
gaspi_allreduce_elem_max ( elem_max
    ...
    TYPE(gaspi_number_t), INTENT(OUT) :: elem_max
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_network_type ( network_type
    ...
    TYPE(gaspi_network_t), INTENT(OUT) :: network_type
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
\executionphasework
...
gaspi_build_infrastructure ( build_infrastructure
    ...
    TYPE(gaspi_number_t), INTENT(OUT) :: build_infrastructure
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_version ( version
    ...
    REAL(kind=c_float), INTENT(OUT) :: version
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_time_get ( wtime
    ...
    TYPE(gaspi_time_t), INTENT(OUT) :: wtime
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
\executionphasework
...
gaspi_time_ticks ( resolution
    ...
    TYPE(gaspi_time_t), INTENT(OUT) :: resolution
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
\begin{FDefSign}
\begin{verbatim}
GASPI_ERROR_MESSAGE ( error_code
                    , error_message )
\end{verbatim}
\end{FDefSign}
\parameterlistbegin
...
gaspi_error_message ( error_code
    ...
    TYPE(gaspi_return_t), INTENT(IN) :: error_code
    TYPE(gaspi_string_t), INTENT(OUT) :: error_message
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_statistic_counter_max ( counter_max
    ...
    TYPE(gaspi_number_t), INTENT(OUT) :: counter_max
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
GASPI_STATISTIC_COUNTER_INFO ( counter
    ...
    TYPE(gaspi_statistic_counter_t), INTENT(IN) ::  counter
    TYPE(gaspi_statistic_argument_t), INTENT(OUT) ::  argument
    TYPE(gaspi_string_t), INTENT(OUT) ::  counter_name
    TYPE(gaspi_string_t), INTENT(OUT) ::  counter_description
    TYPE(gaspi_number_t), INTENT(OUT) ::  verbosity_level
    TYPE(gaspi_return_t), INTENT(OUT) ::  ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_statistic_verbosity_level ( verbosity_level
    ...
    TYPE(gaspi_number_t), INTENT(IN) ::  verbosity_level 
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_statistic_counter_get ( counter
    ...
    TYPE(gaspi_statistic_counter_t), INTENT(IN) ::  counter
    TYPE(gaspi_statistic_argument_t), INTENT(IN) ::  argument
    TYPE(gaspi_number_t), INTENT(OUT) ::  value
    TYPE(gaspi_return_t), INTENT(OUT) ::  ireturn
\end{verbatim}
\end{FDefSign}
...
gaspi_pcontrol ( argument
    ...
    TYPE(gaspi_pointer_t), INTENT(INOUT) ::  argument
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
