...
\begin{verbatim}
gaspi_return_t
gaspi_config_set ( gaspi_configuration_t const *config )
\end{verbatim}
\end{FDefSign}
...
gaspi_build_infrastructure ( build_infrastructure
    ...
    TYPE(gaspi_bool_t), INTENT(OUT) :: build_infrastructure
    TYPE(gaspi_return_t), INTENT(OUT) :: ireturn
\end{verbatim}
\end{FDefSign}
