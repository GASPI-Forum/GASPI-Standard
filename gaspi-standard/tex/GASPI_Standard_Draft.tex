...
After successful procedure completion, i.\,e.\ return value \GASPISUCC{},
the segment is deleted and the resources are released. It is a failure to use the segment for communication
...
Invoking \gaspifunction{segment\_delete} in any other execution
phase than the working phase yields undefined behavior.
