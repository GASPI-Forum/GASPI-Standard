...
\newcommand{\TDefDefn}[1]{\begin{cbox}{EEEEEE}{#1}\end{cbox}}
...
\begin{TDef}
\TDefDefn{\gaspitype{notification\_id}}
\TDefDesc{The \GASPI{} notification ID type.}
\end{TDef}

\begin{TDef}
\TDefDefn{\gaspitype{tag}}
...
\begin{TDef}
\TDefDefn{\gaspitype{atomic\_value}}
\TDefDesc{The \GASPI{} global atomic value type.}
\end{TDef}

\begin{TDef}
\TDefDefn{\gaspitype{return}}
