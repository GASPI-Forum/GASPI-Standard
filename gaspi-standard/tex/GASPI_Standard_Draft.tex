...
\begin{verbatim}
gaspi_return_t
gaspi_group_num ( gaspi_number_t * const group_num )
\end{verbatim}
\end{FDefSign}
...
\begin{verbatim}
gaspi_return_t
gaspi_segment_num ( gaspi_number_t * const segment_num )
\end{verbatim}
\end{FDefSign}
