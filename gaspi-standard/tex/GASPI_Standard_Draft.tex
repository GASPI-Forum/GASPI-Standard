...
\begin{verbatim}
gaspi_return_t
gaspi_notify ( gaspi_rank_t const rank
...
\begin{verbatim}
gaspi_return_t
gaspi_notify_waitsome ( gaspi_notification_id_t const notification_begin
...
\begin{verbatim}
gaspi_return_t
gaspi_notify_reset ( gaspi_notification_id_t const notification_id
...
gaspi_reduce_operation ( gaspi_pointer_t operand_one
                       , gaspi_pointer_t operand_t constwo
...
\begin{verbatim}
gaspi_return_t
gaspi_error_message ( gaspi_return_t const error_code
