...
\title{\GASPI{}: Global Address Space Programming Interface\\~\\Specification of a general purpose API for communication.\\~\\version 0.91}
...
replaces MPI completely at Fraunhofer ITWM. In 2011 the partners of
...
\GASPI{} processes registers with the other remote \GASPI{} processes.
