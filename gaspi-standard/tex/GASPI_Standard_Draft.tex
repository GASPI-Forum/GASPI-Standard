...
Whenever you add a rank the list of ranks is sorted in ascendinging order.
...
side. For completed requests the transmitted data is available for the application.
